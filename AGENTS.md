...
Этот файл — постоянная память проекта. Он обязателен для любого человека или ИИ, который продолжает разработку PumpSignal в новом чате или рабочем сеансе.

## Что делать перед любой работой
...
6. После каждого изменения обязательно обновлять `DEVELOPMENT_LOG.md` в том же коммите или PR.
