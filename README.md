...
- На экране проверки теперь видно PUMP и еще 10 популярных монет отдельными кнопками.
- Монеты: PUMP, BTC, ETH, SOL, BNB, XRP, DOGE, ADA, TRX, AVAX, LINK.
- Можно отдельно выбрать риск RSI 30 или RSI 35.
- Проверка использует ту же стратегию на 30-минутных свечах.
